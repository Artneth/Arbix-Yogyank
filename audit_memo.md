...
*    The script modified target 'target_entitlement_score' directly during training by subtracting 150 points. This prevents the ML model from learning the data patterns.
...
*   Removed the step that modifies the target variable.
